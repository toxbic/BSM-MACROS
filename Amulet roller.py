                ...
                for t in targets:
                    ...
                    if t == "pollen":
                        ...
                        if re.search(pattern, text_found):
                            ...
                            if not any(x in text_found for x in ["white pollen", "red pollen", "blue pollen", "bee pollen gather"]):
                                matches_found += 1
                                found_list.append(t)
                            elif text_found.count("pollen") > (("white pollen" in text_found) + ("red pollen" in text_found) + ("blue pollen" in text_found) + ("bee pollen gather" in text_found)):
